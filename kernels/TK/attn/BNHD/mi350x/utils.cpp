...
__device__ inline void buffer_store_vec2(float2 data, i32x4 srsrc, uint32_t offset_bytes) {
    const int cc = static_cast<int>(coherency::cache_all);
    llvm_amdgcn_raw_buffer_store_b64(std::bit_cast<uint64_t>(data), srsrc, offset_bytes, 0, cc);
}
