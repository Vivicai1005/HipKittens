...
void micro_tk(const micro_globals g) {
    ...
    prefill_swizzled_offsets<2, false, rt_f6<REG_BLOCK_M, K_STEP>, st_f6<BLOCK_SIZE, K_STEP>, _gl_A, coord<st_f6<BLOCK_SIZE, K_STEP>>, NUM_THREADS>(g.a, {0, 0, row, 0}, As[tic], swizzled_offsets_A);
    prefill_swizzled_offsets<2, false, rt_f6<REG_BLOCK_M, K_STEP>, st_f6<BLOCK_SIZE, K_STEP>, _gl_B, coord<st_f6<BLOCK_SIZE, K_STEP>>, NUM_THREADS>(g.b, {0, 0, col, 0}, Bs[tic], swizzled_offsets_B);
