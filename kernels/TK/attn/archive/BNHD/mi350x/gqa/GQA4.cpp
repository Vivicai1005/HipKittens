...
__global__ void attend_ker(const attn_globals<D> g) {
    ...
    load_global_to_shared_direct<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
        g.Kg, {batch_idx, 0, head_idx_kv, 0}, k_smem[0]);
    ...
    load_global_to_shared_direct<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
        g.Kg, {batch_idx, 1, head_idx_kv, 0}, k_smem[1]);
    load_global_to_shared_direct<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
        g.Vg, {batch_idx, 0, head_idx_kv, 0}, v_smem[0]);
    ...
    load_global_to_shared_direct<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
        g.Kg, {batch_idx, 2, head_idx_kv, 0}, k_smem[0]);
    ...
    load_global_to_shared_direct<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
        g.Vg, {batch_idx, 1, head_idx_kv, 0}, v_smem[1]);
    ...
    for (int j = 3; j < num_tiles - 1; j += 2) {
        ...
        //      Load K3 into shared 
        load_global_to_shared_direct<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
            g.Kg, {batch_idx, j, head_idx_kv, 0}, k_smem[0]);
        ...
        //      Load V2 into shared
        load_global_to_shared_direct<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
            g.Vg, {batch_idx, j - 1, head_idx_kv, 0}, v_smem[0]);
        ...
        //      Load K4 into shared
        load_global_to_shared_direct<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
            g.Kg, {batch_idx, j + 1, head_idx_kv, 0}, k_smem[0]);
        ...
        //      Load V3 into shared
        load_global_to_shared_direct<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
            g.Vg, {batch_idx, j, head_idx_kv, 0}, v_smem[1]);
    ...
    //      Load K5 into shared
    load_global_to_shared_direct<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
        g.Kg, {batch_idx, num_tiles - 1, head_idx_kv, 0}, k_smem[1]);
    ...
    //      Load V4 into shared
    load_global_to_shared_direct<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
        g.Vg, {batch_idx, num_tiles - 2, head_idx_kv, 0}, v_smem[0]);
    ...
    //      Load V5 into shared
    load_global_to_shared_direct<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
        g.Vg, {batch_idx, num_tiles - 1, head_idx_kv, 0}, v_smem[1]);
