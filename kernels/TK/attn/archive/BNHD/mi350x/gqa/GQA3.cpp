...
__global__ void attend_ker(const attn_globals<D> g) {
    ...
    load_global_to_shared_direct<1, false, st_bf<BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
    ...
    for (int j = 3; j < num_tiles - 1; j += 2) {
        ...
        //      Load K3 into shared 
        load_global_to_shared_direct<1, false, st_bf<BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
            g.Kg, {batch_idx, j, head_idx_kv, 0}, k_smem[1]);
